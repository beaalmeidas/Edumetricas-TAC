# Edumetricas: progresso inicial e datasets
...
## Sumário
- [Edumetricas: progresso inicial e datasets](#edumetricas-progresso-inicial-e-datasets)
  - [Sumário](#sumário)
...
**OBS SOBRE A ORIGEM.:**
Esses conjuntos foram gerados utilizando LLM (claude-4.6), dado que não foi possível encontrar um dataset de informações escolares com o nível de complexidade necessário para desempenho do projeto.
<br />
Houve um período extenso de avaliação de requisitos e modelagem dos datasets antes disso. As informações utilizadas são dados comuns que uma escola possuiria.
...
As fontes desses datasets podem ser encontradas na próxima seção.
